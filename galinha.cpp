...
int main(int argc, char **argv)
{
  ...
  robot.moveTo(ArPose(8.981, 2.825));

 ArLog::log(ArLog::Normal, "Nova Pose: Pose=(%.2f,%.2f)",
    robot.getRawEncoderPose().getX(), robot.getRawEncoderPose().getY());


 ArActionGoto gotoPoseAction("goto");

  robot.addAction(&gotoPoseAction, 60);
 gotoPoseAction.setGoal(ArPose(3.618, 4.108));
